package dev.changuii.project.security.config;
...
public class SecurityConfig {
    ...
    private final dev.changuii.project.security.service.JwtProvider JwtProvider;
...
//                )
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://127.0.0.1:3000", "https://lexiassistant.netlify.app"));
